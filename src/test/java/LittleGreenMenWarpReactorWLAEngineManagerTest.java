...
public class LittleGreenMenWarpReactorWLAEngineManagerTest {
	...
	public void setUp() throws Exception {
		logger = Logger.getLogger(LittleGreenMenWarpReactorWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LittleGreenMenWarpReactorWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LittleGreenMenWarpReactorWLAIW/InitOutcome.xml").getDocumentElement();
